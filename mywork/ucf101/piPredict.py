...
def rgb_video_predict():
	...
	net = caffe.Net(caffe_root + 'mywork/ucf101/pi_tsn_bn_inception_rgb_deploy.prototxt',model_root +'model/tsp-bn-ucf1-rgb/ucf_rgb_bn_inception_iter_80000.caffemodel',caffe.TEST)
